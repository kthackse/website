...
SECRET_KEY = os.environ.get('SECRET_KEY', '6_$8zsh&07=@+j-q%#e^h22ht_@+q^g+l)xd(&wwf)$gu5lgr^')
...
if os.environ.get('PG_NAME', None) and os.environ.get('PG_USER', None) and os.environ.get('PG_PWD', None):
    DATABASES = {
        'default': {
