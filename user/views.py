...
from event.utils.utils import get_applications_by_user, is_application_to_review, get_next_or_past_event
            ...
            if user:
                ...
                if next_page == "/":
                    if user.is_organiser and is_application_to_review(user.id):
                        ...
                        return HttpResponseRedirect(reverse("event_applicationsreview", kwargs=dict(code=event.code)))
                    return HttpResponseRedirect(reverse("app_dashboard"))
