    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('applications', models.ManyToManyField(to='application.Application')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('vote_tech', models.IntegerField(validators=[application.models.valid_vote])),
                ('vote_personal', models.SmallIntegerField(validators=[application.models.valid_vote])),
