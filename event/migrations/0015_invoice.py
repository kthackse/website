# Generated by Django 2.2.4 on 2019-08-11 11:36
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company_event', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='event.CompanyEvent')),
                ('responsible_company', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='responisble_company', to=settings.AUTH_USER_MODEL)),
                ('responsible_event', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='responisble_event', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
