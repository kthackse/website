# Generated by Django 2.2.3 on 2019-07-19 20:41
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.PositiveSmallIntegerField(choices=[(0, 'PENDING'), (1, 'CANCELLED'), (2, 'INVITED'), (3, 'CONFIRMED'), (4, 'REJECTED'), (5, 'REMINDED'), (6, 'EXPIRED'), (7, 'DUBIOUS'), (8, 'ATTENDED')])),
                ...
                ('diet', models.PositiveSmallIntegerField(choices=[(0, 'REGULAR'), (1, 'VEGETARIAN'), (2, 'VEGAN'), (3, 'PORK_FREE'), (4, 'GLUTEN_FREE'), (5, 'LACTOSE_FREE'), (6, 'SEAFOOD_FREE'), (7, 'OTHER')])),
                ('diet_other', models.CharField(blank=True, max_length=255, null=True)),
                ('tshirt', models.PositiveSmallIntegerField(choices=[(10, 'XXS'), (20, 'XS'), (30, 'S'), (40, 'M'), (50, 'L'), (60, 'XL'), (70, 'XXL'), (80, 'XXXL')])),
                ...
                ('invited_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='invited_by', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Team',
            ...
            options={
                'unique_together': {('event', 'code'), ('event', 'creator')},
            },
        ),
        migrations.CreateModel(
            name='Reimbursement',
